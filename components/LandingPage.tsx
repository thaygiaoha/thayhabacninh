  ...
  >
    ...
    <span>Lời giải</span>
            ...
            <div className="mt-4 pt-6 border-t border-slate-100 flex flex-col gap-3 w-full">
              <button onClick={() => setView('exam-creator')} className="w-full bg-gradient-to-r from-emerald-500 to-teal-600 text-white p-4 rounded-2xl font-black text-xs uppercase shadow-lg border-b-4 border-emerald-800 hover:brightness-110 active:scale-95 transition-all flex items-center justify-center gap-3 group">
